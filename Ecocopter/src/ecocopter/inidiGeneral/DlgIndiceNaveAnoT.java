...
import ecocopter.beanDataSource.indicesGene.DSIndiceGeneNoveno;
 ...
 * @author Cesar
 */
public final class DlgIndiceNaveAnoT extends javax.swing.JFrame {
DefaultTableModel dt=new DefaultTableModel();
FacadeReportes reportes=new FacadeReportes();
FacadeHoras horas=new FacadeHoras();
DSIndiceGeneNoveno data= null;
List<DSIndiceGeneNoveno> lst = new ArrayList<DSIndiceGeneNoveno>();
public String ano=""; 
private int cantHoras=0;
    public DlgIndiceNaveAnoT() {
        initComponents();
        cargarTamano();
        desabilitaTexto();
        clearTexto();
...
public void cargarTamano(){//llamar este metodo en el constructor
  ...
  this.setDefaultCloseOperation(DlgIndiceNaveAnoT.DO_NOTHING_ON_CLOSE);//inavilitar el cerrado
...
private void setTitulo(){
  this.setTitle("N°Indice de Fallas vs. Aeronaves ");
 } 
...
public void cargaJasper(){
       try {
           ...
           String rutaInform="\\\\"+VariablesConexion.ip+"\\Sistema\\reportes\\indiceNoveno.jasper";
...
private String  anos(){
    ...
    private void initComponents() {
        ...
        txtIndice.setBounds(90, 90, 70, 25);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(capa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 863, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        for(ReportesGenerales x:reportes.ListReporteNaveAno(this.getAno())){
            ...
            data=new DSIndiceGeneNoveno(x.getNomNave(),x.getCantAta(),this.getCantHoras(),indice);
            lst.add(data);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgIndiceNaveAnoT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DlgIndiceNaveAnoT().setVisible(true);
            }
        });
    }
