...
import ecocopter.beanDataSource.indicesGene.DSIndiceGeneSegundo;
...
public final class DlgIndiceAtasMesNave extends javax.swing.JFrame {
    ...
    private String codNave="";
     DSIndiceGeneSegundo data= null;
   List<DSIndiceGeneSegundo> lst = new ArrayList<DSIndiceGeneSegundo>();
    public DlgIndiceAtasMesNave() {
        initComponents();
        setTitulo();
        setColumnName();
        cargarTamano();
   ...
   public void cargarTamano(){//llamar este metodo en el constructor
     ...
     this.setDefaultCloseOperation(DlgIndiceAtasMesNave.DO_NOTHING_ON_CLOSE);//inavilitar el cerrado
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cmbmes, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        double indice=0;
        int falla=0;
        this.setMes("0"+numMes());
        this.setCodNave(getCastCodNave());
        this.setAno(this.anos().trim());
        this.setCantHoras(cantHorasMesNaveAno());
        DefaultCategoryDataset datos = new DefaultCategoryDataset();
        for(ReportesGenerales x:reportes.ListReporteAtaNaveMes(this.getCodNave().trim(),this.getMes().trim(),this.getAno())){
        ...
        datos.setValue(indice,"Fallas", x.getCodAta());//pintamos el grafico
        dt.addRow(new Object[]{x.getCodAta(),x.getCantAta(),this.getCantHoras(),indice} );//pintamos la grilla
        data=new DSIndiceGeneSegundo(x.getCodAta(),x.getCantAta(),this.getCantHoras(),indice);
        lst.add(data);
       ...
       // JFreeChart barchart=ChartFactory.createLineChart("Indice de Fallas vs. Atas ", "Atas", "Indice de Fallas", datos,PlotOrientation.VERTICAL,true,true,false);
        JFreeChart barchart=ChartFactory.createBarChart("Indice de Fallas vs. Atas ", "Atas", "Indice de Fallas", datos,PlotOrientation.VERTICAL,true,true,false);
...
*/
    ...
    public void cargaJasper(){
        try {
            ...
            String rutaInform="\\\\"+VariablesConexion.ip+"\\Sistema\\reportes\\indiceSexto.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgIndiceAtasMesNave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DlgIndiceAtasMesNave().setVisible(true);
            }
        });
    }
