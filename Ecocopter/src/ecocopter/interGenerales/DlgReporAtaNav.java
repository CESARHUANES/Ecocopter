...
import ecocopter.beanDataSource.reportajesGene.DSRepGeneQuinto;
 ...
 * @author Cesar
 */
public final class DlgReporAtaNav extends javax.swing.JFrame {
DefaultTableModel dt=new DefaultTableModel();
FacadeReportes reportes=new FacadeReportes();
FacadeHoras horas=new FacadeHoras();
DSRepGeneQuinto data= null;
List<DSRepGeneQuinto> lst = new ArrayList<DSRepGeneQuinto>();
private String codNave="";
public String ano=""; 
private int cantHoras=0;

    public DlgReporAtaNav() {
        initComponents();
        listarCombo();
        cargarTamano();
        desabilitaTexto();
...
private void desabilitaTexto(){
  ...
  private void clearTexto(){
    ...
    private void setTitulo(){
     this.setTitle("N°Fallas vs. Atas ");
    }  
    ...
    JTable.getColumnModel().getColumn(3).setPreferredWidth(80);
     ...
     private void totalHorasAno(String codNave,String ano){
      
     setCantHoras(horas.getCantHorasNaveAno(codNave,ano));
    ...
    totalIndice=totalFallas/totalHoras; 
      System.out.println("Indice Fallas2"+totalIndice);
   ...
   public void cargaJasper(){
       try {
           ...
           String rutaInform="\\\\"+VariablesConexion.ip+"\\Sistema\\reportes\\reporte5.jasper";
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        this.totalHorasAno(getCastCodNave(),this.getAno());
        DefaultCategoryDataset datos = new DefaultCategoryDataset();
        for(ReportesGenerales x:reportes.ListReporteAtaNaveT(this.getCodNave(),this.getAno())){
          ...
          data=new DSRepGeneQuinto(x.getCodAta(),x.getCantAta());
          lst.add(data);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgReporAtaNav.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DlgReporAtaNav().setVisible(true);
            }
        });
    }
