...
import ecocopter.beanDataSource.reportajesGene.DSRepGeneSeptimo;
 ...
 * @author Cesar
 */
public final class DlgReporAtaNaveT extends javax.swing.JFrame {
DefaultTableModel dt=new DefaultTableModel();
FacadeReportes reportes=new FacadeReportes();
FacadeHoras horas=new FacadeHoras();
DSRepGeneSeptimo data= null;
List<DSRepGeneSeptimo> lst = new ArrayList<DSRepGeneSeptimo>();
public String ano=""; 
 private int cantHoras=0;

    public DlgReporAtaNaveT() {
        initComponents();
        cargarTamano();
        desabilitaTexto();
        clearTexto();
...
private void desabilitaTexto(){
  ...
  private void clearTexto(){
    ...
    private void setTitulo(){
     this.setTitle("Reportes Totales-N°Fallas vs. Atas ");
    }  
   ...
   public void cargaJasper(){
       try {
           ...
           String rutaInform="\\\\"+VariablesConexion.ip+"\\Sistema\\reportes\\reporte7.jasper";
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        for(ReportesGenerales x:reportes.ListReporteAtaT(this.getAno())){
            ...
            data=new DSRepGeneSeptimo(x.getCodAta(),x.getCantAta());
            lst.add(data);      
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgReporAtaNaveT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DlgReporAtaNaveT().setVisible(true);
            }
        });
    }
