...
import ecocopter.beanDataSource.indicesParti.DSIndicePartiTercero;
 ...
 * @author desarrollo2
 */
public final class DlgIndiceMesAtas extends javax.swing.JFrame {
   DefaultTableModel dt=new DefaultTableModel(); 
   public String codAta="";
   public String ano="";
   
    DSIndicePartiTercero data= null;
   List<DSIndicePartiTercero> lst = new ArrayList<DSIndicePartiTercero>();
   /**
     * Creates new form DlgIndiceMesAtas
     */
    public DlgIndiceMesAtas() {
        initComponents();
         listarCombo();
   ...
   public void cargarTamano(){//llamar este metodo en el constructor
     ...
     this.setDefaultCloseOperation(DlgIndiceMesAtas.DO_NOTHING_ON_CLOSE);//inavilitar el cerrado
   ...
   private void calcularDatos(int totalFallas,int totalHoras){
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        ...
        for(ReportesParticulares x:reportes.ListReporte2(this.getCodAta(), this.getAno())){
            int cantHoras=horas.getCantHoras(x.getMes().toLowerCase().trim(), this.getAno());
            ...
            data=new DSIndicePartiTercero(x.getMes(),x.getCantAta(),cantHoras,indice);
            lst.add(data);
            }
            }
    ...
    public void cargaJasper(){
        try {
            ...
            String rutaInform="\\\\"+VariablesConexion.ip+"\\Sistema\\reportes\\indiceTercero.jasper";
   ...
   ArrayList lista=(ArrayList)FacadeReportes.ListAtas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgIndiceMesAtas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DlgIndiceMesAtas().setVisible(true);
            }
        });
    }
