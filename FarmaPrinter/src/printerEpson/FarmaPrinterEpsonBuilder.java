...
public byte[] setFontA(){
byte[] fontA=new byte[]{(byte)chr(27), (byte)'!', (byte)chr(32) };//M-48
return fontA;
}
public byte[] setFontB(){
...
byte[]  feedLine=new  byte[]{(byte)chr(27),(byte)chr(51),(byte)chr(40)    
};//espacio entre linea
return feedLine;
}

public byte[] inicializate(){
byte[] inicializate=new byte[]{(byte)chr(29),(byte)'@'};
return inicializate;
}
public byte[] setOnPrintBold(){
byte[] bold=new byte[]{(byte)chr(27),'E',(byte)chr(1)};
return bold;
}
public byte[] setOffPrintBold(){
byte[] bold=new byte[]{(byte)chr(27),'E',(byte)chr(0)};
return bold;
}
